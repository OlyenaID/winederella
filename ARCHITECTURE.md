...
- **Pinot Noir/Nebbiolo rule was too blunt at the margin** (August 2026) — the flat "never under $30" rule didn't distinguish a genuine risk zone from a defensible judgment call. Replaced with three price bands: under $25 still steers to alternatives (Gamay, Nero d'Avola, Barbera, Cinsault); $25–$30 allows a specific bottle only if Wini would actually stand behind it, flagged casually as near the low end rather than with a formal disclaimer; $30 and above needs no caveat. Rosé exception and the white/red price floors are unchanged.
